...
/***/ "./apps/user/src/user/dto/create-user.dto.ts":
/*!***************************************************!*\
  !*** ./apps/user/src/user/dto/create-user.dto.ts ***!
  \***************************************************/
...
/***/ "./apps/user/src/user/dto/update-user.dto.ts":
/*!***************************************************!*\
  !*** ./apps/user/src/user/dto/update-user.dto.ts ***!
  \***************************************************/
...
const create_user_dto_1 = __webpack_require__(/*! ./create-user.dto */ "./apps/user/src/user/dto/create-user.dto.ts");
...
const user_service_1 = __webpack_require__(/*! ./user.service */ "./apps/user/src/user/user.service.ts");
const create_user_dto_1 = __webpack_require__(/*! ./dto/create-user.dto */ "./apps/user/src/user/dto/create-user.dto.ts");
const update_user_dto_1 = __webpack_require__(/*! ./dto/update-user.dto */ "./apps/user/src/user/dto/update-user.dto.ts");
...
const common_1 = __webpack_require__(/*! @nestjs/common */ "@nestjs/common");
const user_service_1 = __webpack_require__(/*! ./user.service */ "./apps/user/src/user/user.service.ts");
const user_controller_1 = __webpack_require__(/*! ./user.controller */ "./apps/user/src/user/user.controller.ts");
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
__exportStar(__webpack_require__(/*! ./user */ "./libs/common/src/types/user.ts"), exports);


/***/ }),

/***/ "./libs/common/src/types/user.ts":
/*!***************************************!*\
  !*** ./libs/common/src/types/user.ts ***!
  \***************************************/
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
function UserServiceControllerMethods() {
    return function (constructor) {
        const grpcMethods = ["createUser", "findAllUser", "findOneUser", "updateUser"];
...
const user_module_1 = __webpack_require__(/*! ./user/user.module */ "./apps/user/src/user/user.module.ts");
const microservices_1 = __webpack_require__(/*! @nestjs/microservices */ "@nestjs/microservices");
